<div class="modal fade bs-contact-modal" id="selectModal" tabindex="-1" role="dialog" aria-labelledby="selectModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-search col-md-2">
                <input type="text" class="form-control" id="search_id" value="" name="search_id" onkeyup="Select.searchByID(this.value);" placeholder="Search with ID" autofocus>
            </div>
            <div class="modal-search col-md-10">
                <input type="text" class="form-control w50p" id="keyword" value="" name="keyword" onkeyup="Select.searchByKeyword(this.value+'%');" placeholder="Search with name">
            </div>
