    ...
    <div class="row">
        <div class="col-xs-12">
                <div class="box-body">            
                    ...
                    <div class="form-group form-group-sm">
                        <label class="col-xs-2">{{trans('text.country')}}</label>
                        <div class="col-xs-10">
                        <?php
                    ...
                    <div class="form-group form-group-sm">
                        <label class="col-xs-2">{{trans('text.type')}}</label>
                        <div class="col-xs-10">
                            <select class="form-control" id="type" name="type">
                                <option value="agency" <?php if( isset($item->type) &&  $item->type == 'agency' ){ echo "selected='selected'"; }?> >{{trans('text.agency')}}</option>
                                <option value="direct" <?php if( isset($item->type) &&  $item->type == 'direct' ){ echo "selected='selected'"; }?>>{{trans('text.direct')}}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-group-sm">
                        <label class="col-xs-2">{{trans('text.name')}}</label>
                        <div class="col-xs-10">
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <label class="col-xs-2">{{trans('text.contact_list')}}</label>
                        <div class="col-xs-10">
