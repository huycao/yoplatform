			...
			<div class="filter-wrapper">
				<div class="row">
					...
					<div class="col-xs-6">
						...
						<div class="form-group form-group-sm">
						    <label for="type" class="col-xs-2 control-label">{{trans('text.type')}}</label>
						    <div class="col-xs-10">
								<select name="type" class="form-control">
									<option value="">Select Type</option>
									<option value="agency">{{trans('text.agency')}}</option>
									<option value="direct">{{trans('text.direct')}}</option>
								</select>					    
							</div>
						</div>
					</div>			
