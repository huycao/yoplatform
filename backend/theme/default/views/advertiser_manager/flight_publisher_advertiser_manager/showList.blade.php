				...
				<div class="col-xs-12">
					<table class="table table-responsive table-condensed table-bordered">
						...
						<tr>
							...
							<td class="bg-default" width="15%">{{trans('text.zone')}}</td>
							<td width="35%">
			                    <input type="hidden" id="publisher_ad_zone_id" value="" name="publisher_ad_zone_id">
			                    <input type="text" class="input-sm w49p" id="publisher_ad_zone" value="">
                    			<a href="javascript:;" onclick="Select.openModal('publisher_ad_zone')" class="btn btn-primary w49p btn-sm">{{trans('text.select_zone')}}</a>
							</td>
						</tr>
						<tr>
							...
							<td class="bg-default" width="15%">{{trans('text.remark')}}</td>
							<td width="35%"><input type="text" class="form-control input-sm" id="remark" name="remark"></td>
						</tr>
						<tr>
							<td class="bg-default" width="15%">{{trans('text.channel')}}</td>
							<td width="35%">
				                {{ 
				                    Form::select(
				                        'category_id', 
							...
							<td class="bg-default" width="15%">{{trans('text.model')}}</td>
							<td width="35%">
				                {{ 
				                    Form::select(
				                        'cost_type', 
