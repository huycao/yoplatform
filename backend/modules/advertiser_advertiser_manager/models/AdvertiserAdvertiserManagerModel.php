...
class AdvertiserAdvertiserManagerModel extends AdvertiserBaseModel {
	...
	public function getUpdateLangs(){
		return array(
			'name.required'		=>	trans('advertiser::validate.name.required'),
			'country.required'	=>	trans('advertiser::validate.country.required')
		);
	}
