...
Route::group(array('before' => 'basicAuth', 'prefix'    => Config::get('backend.uri').'/publisher' ),function(){
    ...
    Route::group(array('prefix' => 'tools' ),function() {
       ...
       //payment request
        ...
        Route::get('export/{id}',   array('before' =>   'hasPermissions:'.$prefixSlug.'-edit','as'    =>  $prefixName.'ExportExcelPaymentDetail','uses' =>  $prefixName.'Controller@exportExcelPaymentDetail'));
