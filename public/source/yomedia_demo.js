...
var avlInteractModule = new function(){
	...
	return {
		...
		initVideoInline: function(pid, elw, elh, el, w, z, fp, a, az, autoStart, v, d){
		...
		initVideoPopup: function(pid, elw, elh, el, w, z, fp, a, az, autoStart, v, d, cs){
            ...
            jwplayer(elVideoInner).setup({
			    "flashplayer": avlConfig.get('JW'),
				'logo.file': "http://static.openvideoads.org/qa/1.0.0-rc3/rc3-29/ova.jwplayer.5x/dist/images/hc-player.png",
		...
		initBalloon: function(a, b, w, h, c, e, f, g, i, z, o, p, s, t, u, y, it) {
            ...
            swfobjectAVL.embedSWF(f, avlConfig.get('ICW') + a, w, h, "9.0.0", avlConfig.get('EI'), bL, bM, bN);
		},
        isFlash: function() {
		...
		initBanner: function(a, b, w, h, f, z, s) {
            var M = '<div id="' + avlConfig.get('ICW') + a + '"></div>';
	        if (domManipulate.getElid(a)) domManipulate.remove(a);
	        document.write("<div id='"+a+"'></did>");
	        var d = domManipulate.getElid(a);
        ...
        setControl: function(a, b) {
            var a = swfobjectAVL.getObjectById(a);
		...
		init : function(initVar){
			if (typeof initVar !== 'undefined' && navigator.cookieEnabled) {
			    if (initVar.length > 0) {
					...
					var varObj 				= {
						"type": initVar[lastIndexInitVar][2],
