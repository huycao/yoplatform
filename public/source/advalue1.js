...
var avlInteractModule = new function(){
	...
	return {
		...
		initBalloon: function(a, b, w, h, c, e, f, g, i, z, o, p, s, t, u, y) {
            ...
            var bL = {
                zid: z,
                baseUrl : encodeURIComponent("http://static.yomedia.vn/yomedia/vib_mega")
            };
            var bM = {
                ...
                quality: "high",
                wmode: s,
                base : "http://static.yomedia.vn/yomedia/vib_mega"
            };
            var bN = {
                id: b,
                name: b
            };
            swfobject.embedSWF(f, avlConfig.get('ICW') + a, w, h, "9.0.0", avlConfig.get('EI'), bL, bM, bN);
		},
        isFlash: function() {
